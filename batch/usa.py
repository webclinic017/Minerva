...
def realGDP_projection():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_0100.png')
...
def unemployment_projection():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_0200.png')
...
def pce_projection():
    ...
    # 이미지 파일로 저장
    plt.tight_layout()  # 서브플롯 간 간격 조절
    plt.savefig(reports_dir + '/usa_0300.png')
...
def effective_rate():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_0400.png')
...
def component_series():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_0500.png')
...
def nonfarm_payroll():
    ...
    plt.legend()
    plt.grid()
    plt.savefig(reports_dir + '/usa_0600.png')
...
def hires_vs_jobopen():
    ...
    plt.yscale('log')
    plt.legend()
    plt.savefig(reports_dir + '/usa_0700.png')
...
def sp500_profits_realgdp():
    ...
    plt.savefig(reports_dir + '/usa_0800.png')
...
def m2v_vs_m2s():
    ...
    ax1.legend(lns, lnses, loc=6)
    ax2.legend(lns1, lns1, loc=4)
    plt.savefig(reports_dir + '/usa_0900.png')
...
def unemploy_ahead_retail():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1000.png')
...
def expect_vs_10yminus5y():
    ...
    # 이미지 파일로 저장
    plt.tight_layout()  # 서브플롯 간 간격 조절
    plt.savefig(reports_dir + '/usa_1100.png')
...
def smoothed_recession_prob():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1200.png')
...
def sahm_recession():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1210.png')
...
def high_yield_spread(CONF_INTVL):
    ...
    # 이미지 파일로 저장
    plt.tight_layout()  # 서브플롯 간 간격 조절
    plt.savefig(reports_dir + '/usa_1300.png')
...
def y10minusy2():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1400.png')
...
def y10minusm3():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1500.png')
...
def total_assets_and_rp():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1600.png')
...
def y10_crak_line():
    ...
    plt.legend()
    plt.savefig(reports_dir + '/usa_1700.png')
...
def rp_total():
    ...
    plt.savefig(reports_dir + '/usa_1800.png')
...
def total_bank_reserves():
    ...
    plt.savefig(reports_dir + '/usa_1900.png')
...
def loans():
    ...
    ax1.legend(lns, lnses, loc=2)
    ax2.legend(lns6, lns6, loc=1)
    plt.savefig(reports_dir + '/usa_2000.png')
...
def when_is_the_day():
    ...
    ax1.legend(lns, lnses, loc=2)
    ax2.legend(lns6, lns6, loc=4)
    plt.savefig(reports_dir + '/usa_2100.png')
