...
'''
1.8 genericAlgo_bb_strategy
'''
def genericAlgo_bb_strategy(ticker):
    # Constants
    SOLUTIONS = 20
    GENERATIONS = 50
    TIMEFRAMES = ['1min','1hour','1day']
    ...
    for timeframe in TIMEFRAMES:
        ...
        print(f' {ticker} Best Solution Parameters '.center(60, '*'))
...
if __name__ == "__main__":
    ...
    for ticker in WATCH_TICKERS:
        genericAlgo_bb_strategy(ticker) # Bolinger Band Strategy + 임계값 찾는 Generic Algorithm       
    ...
    for ticker in WATCH_TICKERS:
        file_name = data_dir + f'/{ticker}_hist_1day.csv'
