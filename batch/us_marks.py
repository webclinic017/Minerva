...
day30_ago = (datetime.now() - timedelta(days=30)).date().strftime('%Y-%m-%d')  # days 만 있어요~
...
#             pass
#     except Exception as e:
#         logger.error(' >>> Exception2: {}'.format(e))
...
#                 pass
#         except Exception as e:
#             logger.error(' >>> Exception3: {}'.format(e))
...
#                 pass
#         except Exception as e:
#             logger.error(' >>> Exception4: {}'.format(e))
...
#             pass
#     except Exception as e:
#         logger.error(' >>> Exception5: {}'.format(e))
    ...
    for x in WATCH_TICKERS['US']:
        ...
        for asset, tickers in x.items():
            ...
            for ticker in tickers:
                ...
                mi.get_stock_history_by_fmp(ticker, TIMEFRAMES)
